...
| Application  | [Kubernetes MCP Server](https://github.com/containers/kubernetes-mcp-server)                        | JWT-gated MCP for cluster operations; pod SA kube client (not Hydra passthrough); see [MCP authentication](documentation/mcp-auth.md)                                   |
...
| Application  | [UniFi MCP](https://github.com/sirkirby/unifi-mcp)                                                  | JWT-gated MCP for UniFi Network operations; edge auth only, controller credentials stay in-cluster; see [MCP authentication](documentation/mcp-auth.md)                 |
...
| Security     | [Ory Hydra](https://www.ory.com/hydra)                                                               | OAuth 2.0 / OIDC issuer (`auth.siutsin.com`); issues short-lived tokens for MCP machine clients; public JWKS under `jwks/`                                              |
