...
| Application  | [UniFi MCP](https://github.com/sirkirby/unifi-mcp)                                                  | Model Context Protocol server for UniFi Network controller operations                                                                                                   |
...
| Connectivity | [Tailscale](https://tailscale.com/docs/kubernetes-operator)                                         | Kubernetes operator that publishes the Envoy Gateway VIP onto a Tailscale tailnet                                                                                       |
...
| Connectivity | Tailscale     | [Tailscale](https://tailscale.com/)                                                      | Private overlay network                      |
